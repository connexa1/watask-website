...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'WhatsApp Groups API Limits Explained (2026)',
    description: 'Meta\'s official WhatsApp Groups API is limited to 8 participants per group, invite-only, and requires OBA. Learn what the API can and cannot do for your existing groups.',
    url: 'https://watask.com/guides/whatsapp-groups-api-limits',
    type: 'article',
  },
};
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="prose prose-lg max-w-none">
          <section className="mb-12">
            <div className="bg-red-50 border-2 border-red-200 rounded-xl p-8 mb-8">
              ...
              <p className="text-gray-700 mb-4 leading-relaxed text-lg">
                The Meta WhatsApp Groups API is limited to groups with a <strong>maximum of 8 participants</strong>. These groups must be invite-only and created through the API. You can manage up to <strong>10,000</strong> such groups per business phone number.
              </p>
            ...
            <p className="text-gray-700 leading-relaxed">
              When developers and marketers search for ways to message multiple WhatsApp groups, many assume the official WhatsApp Business API has a solution. The <strong>WhatsApp Groups API</strong> does exist on the Business Platform, but its design and constraints mean it's <em>not</em> the answer for most multi-group campaign needs.
            </p>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-12">
            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 border-2 border-blue-200 rounded-xl p-6">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Every group created through the WhatsApp Groups API is <strong>capped at 8 participants</strong>. This is a hard limit set by Meta. You cannot expand these groups beyond 8 members, and you cannot use the API to post into larger existing consumer or community groups.
                </p>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 border-2 border-purple-200 rounded-xl p-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-3 flex items-center gap-3">
                  <span className="flex-shrink-0 w-8 h-8 bg-purple-600 text-white rounded-lg flex items-center justify-center font-bold">
                    2
                  </span>
                  Groups Must Be API-Created and Invite-Only
                </h3>
                <p className="text-gray-700 leading-relaxed">
                  You cannot use the Groups API to connect to or post into <strong>existing groups</strong> you already manage through the WhatsApp consumer app. The API only works with groups that are <strong>created through the API itself</strong>. Members join via invite links, and the groups are invite-only by design.
                </p>
              ...
              <div className="bg-gradient-to-br from-green-50 to-green-100 border-2 border-green-200 rounded-xl p-6">
                ...
                <p className="text-gray-700 leading-relaxed">
                  While you're limited to 8 participants per group, you <em>can</em> create and manage a large number of these small groups: up to <strong>10,000 groups per business phone number</strong>. This makes the API suitable for highly segmented small-team coordination or structured micro-communities, but not for typical marketing or community groups.
                </p>
              </div>

              <div className="bg-gradient-to-br from-orange-50 to-orange-100 border-2 border-orange-200 rounded-xl p-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-3 flex items-center gap-3">
                  <span className="flex-shrink-0 w-8 h-8 bg-orange-600 text-white rounded-lg flex items-center justify-center font-bold">
                    4
                  </span>
                  Requires Official Business Account (OBA)
                </h3>
                <p className="text-gray-700 leading-relaxed">
                  To use the WhatsApp Groups API, you need an <strong>Official Business Account (OBA)</strong> with Meta. Standard Business Accounts cannot access Groups API features. OBA requirements include verification, compliance with Meta's commerce and messaging policies, and meeting eligibility criteria.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
              <p className="text-gray-700 mb-3 leading-relaxed">
                <strong>What the Groups API is NOT designed for:</strong>
              </p>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 mb-6 leading-relaxed">
              Most people searching for "WhatsApp Groups API" or "send message to multiple WhatsApp groups" are looking for a way to <strong>campaign across their existing large groups</strong>. The 8-participant cap makes the official API unsuitable for this job.
            </p>
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 mb-6">
              ...
              <p className="text-gray-700 leading-relaxed">
                <strong>Problem:</strong> The Groups API can't access those existing groups (they weren't API-created), and even if you could recreate them via API, each would be limited to 8 members — fundamentally changing the nature of the community.
              </p>
            </div>

            <p className="text-gray-700 leading-relaxed">
              This is the disconnect: the Groups API is designed for <strong>creating new small groups</strong>, not <strong>campaigning across existing large groups</strong>. For the latter job, you need multi-group management platforms built specifically for that purpose.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-6">
              <div className="border-2 border-green-600 rounded-lg p-6 bg-green-50">
                ...
                <p className="text-gray-700 leading-relaxed">
                  <strong>Best for:</strong> Agencies, community managers, brands, and multi-location teams who already manage dozens or hundreds of WhatsApp groups and need to run controlled campaigns.
                </p>
                <div className="mt-4">
                  <Link 
              ...
              <div className="border border-gray-200 rounded-lg p-6">
                ...
                <p className="text-gray-700 leading-relaxed">
                  <strong>Best for:</strong> Small group networks (5-10 groups) where manual posting is still manageable.
                </p>
              </div>
              ...
              <div className="border border-gray-200 rounded-lg p-6">
                ...
                <p className="text-gray-700 leading-relaxed">
                  <strong>Best for:</strong> Organizations with hierarchical group structures that map cleanly to the Community model.
                </p>
                <div className="mt-4">
                  <Link 
              ...
              <div className="border border-gray-200 rounded-lg p-6">
                ...
                <p className="text-gray-700 leading-relaxed">
                  <strong>Best for:</strong> Technical teams with developer resources who need full control and customization, and are comfortable managing risk and compliance themselves.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-6">
              <div className="border-b border-gray-200 pb-6">
                ...
                <p className="text-gray-700 leading-relaxed">
                  The WhatsApp Groups API is limited to a <strong>maximum of 8 participants per group</strong>. These groups must be created through the API and are invite-only. This is documented in Meta's official Business Messaging documentation (updated June 2026).
                </p>
              </div>
              ...
              <div className="border-b border-gray-200 pb-6">
                ...
                <p className="text-gray-700 leading-relaxed">
                  <strong>No.</strong> The WhatsApp Groups API can only create and manage new groups with a maximum of 8 participants. It cannot post into your existing consumer or community groups that have 50-500+ members. The API is designed for small, structured communication, not existing large group campaigns.
                </p>
              </div>
              ...
              <div className="border-b border-gray-200 pb-6">
                ...
                <p className="text-gray-700 leading-relaxed">
                  You can create and manage up to <strong>10,000 groups per business phone number</strong> using the WhatsApp Groups API. However, each group is still limited to 8 participants maximum.
                </p>
              </div>
              ...
              <div className="pb-6">
                ...
                <p className="text-gray-700 leading-relaxed">
                  For existing large groups, you need <strong>multi-group management platforms</strong> like WaTask that connect to your existing groups (not the official API) and provide campaign, collection, and pacing features. These platforms are built specifically for posting into many existing groups you already manage.
                </p>
              </div>
            </div>
          </section>
